...
<div class="card">
    <div class="card-header">
       {{--  {{ trans('global.create') }} {{ trans('global.service.title_singular') }} --}}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.services.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('capacite') ? 'has-error' : '' }}">
                ...
                <input type="number" id="capacite" name="capacite" class="form-control" value="{{ old('capacite', isset($service) ? $service->capacite : '') }}">
