...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('global.periode.title_singular')); ?>

    </div>

    <div class="card-body">
        <form action="<?php echo e(route("admin.periodes.update", [$periode->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group <?php echo e($errors->has('niveau_id') ? 'has-error' : ''); ?>">
                ...
                <select name="niveau_id" id="niveau_id" class="form-control select2" >
                    <?php $__currentLoopData = $niveaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $niveau): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($niveau->id); ?>" <?php if($niveau->id==$periode->niveau_id): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravel\resources\views/admin/periodes/edit.blade.php ENDPATH**/ ?>