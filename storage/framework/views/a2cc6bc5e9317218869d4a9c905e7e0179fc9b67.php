    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.users.update", [$user->id])); ?>" method="POST" enctype="multipart/form-data">
           ...
           <div class="form-group <?php echo e($errors->has('nom') ? 'has-error' : ''); ?>">
                ...
                <input type="text" id="nom" name="nom" class="form-control" value="<?php echo e($user->profile->nom); ?>">
            ...
            <div class="form-group <?php echo e($errors->has('prenom') ? 'has-error' : ''); ?>">
                ...
                <input type="text" id="prenom" name="prenom" class="form-control" value="<?php echo e($user->profile->prenom); ?>">
     ...
     <div class="form-group <?php echo e($errors->has('service_id') ? 'has-error' : ''); ?>">
                ...
                <select name="service_id" id="service_id" class="form-control select2"  >
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($service->id); ?>" <?php if($user->profile->service_id==$service->id): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravel\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>