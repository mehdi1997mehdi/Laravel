...
<div class="card">
    <div class="card-header">
        ...
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route("admin.etudiants.make")); ?>">
                ...
                <tbody>
                    <?php $__currentLoopData = $stagaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $stagaire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($stagaire->id); ?>">
                            ...
                            <td>
                                <?php echo e($stagaire->profile->etudiant->cne ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($stagaire->profile->etudiant->nom ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($stagaire->profile->etudiant->prenom ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($stagaire->email ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($stagaire->profile->etudiant->niveau->liblle ?? ''); ?>

                            </td>
                            
                            <td>
                                <?php $__currentLoopData = $stagaire->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td>
                                ...
                                <button class="btn btn-xs btn-danger remove-stagaire" data-id="<?php echo e($stagaire->id); ?>" data-action="<?php echo e(route('admin.etudiants.destroy', $stagaire->id)); ?>"> <i class="fas fa-trash "></i></button>
                                <?php endif; ?>
                                </center>
                            </td>
...
<script>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.etudiants.massDestroy')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravel\resources\views/admin/stagaires/index.blade.php ENDPATH**/ ?>