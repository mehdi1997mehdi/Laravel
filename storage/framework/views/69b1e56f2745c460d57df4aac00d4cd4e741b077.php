...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    <header class="app-header navbar text-primary">
        ...
        <a class="navbar-brand" href="#">
            <span class="navbar-brand-full">FMP FES</span>
            <span class="navbar-brand-minimized">F</span>
        </a>
        ...
        <div>
             ...
             <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><span class="fas fa-user-circle"></span></a> 
              <div class="dropdown-menu dropdown-menu-right">
               <a href="<?php echo e(route('admin.users.password')); ?>" class=" nav-link  dropdown-item"><i class="nav-icon fas fa-user-edit"></i>  Mon compte</a> 
...
<?php /**PATH C:\wamp64\www\laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>